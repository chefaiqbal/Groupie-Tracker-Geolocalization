...
//API - A structure containing the main api and the artists you are looking for
var API AllStruct
var tpl *template.Template
var err error
var vamlet int = 0

//Info - default structure for displaying information about the artist
type Info struct {
	ArtistID interface{}
	CitiesID interface{}
}
...
// ArtistPage - Handler Artist Page
...
// ErrorHandle - Handler Error Pages
